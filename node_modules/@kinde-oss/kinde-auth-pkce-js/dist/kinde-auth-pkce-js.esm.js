...
const createKindeClient = async (options) => {
    ...
    const { audience, client_id: clientId, domain, is_dangerously_use_local_storage = false, redirect_uri, logout_uri = redirect_uri, on_redirect_callback, scope = 'openid profile email offline', _framework, _frameworkVersion } = options;
    ...
    const redirectToKinde = async (options) => {
        const { app_state, start_page, is_create_org, org_name = '', org_code } = options;
